...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2017 a las 17:43:44
...
(64, 'Ecografia', 2, '09:00 AM', 'Dr Curbelo', '9 - 3 - 2017', 'Sabado');
...
(1, 'July ', 'Torres', 'Chavez', 'F', 48533198, 23, '55.5', '1.65', '1994-01-04'),
...
--
ALTER TABLE `cita`
  MODIFY `codcita` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--

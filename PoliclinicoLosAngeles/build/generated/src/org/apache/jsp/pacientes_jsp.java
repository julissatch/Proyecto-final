...
public final class pacientes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<div class=\"container\">\n");
      out.write("\n");
      out.write("      <div class=\"tablamedico col-md-10\">\n");
      out.write("\n");
      ...
      out.write("    ");
                        ...
                        while(resultado.next()){
                                    out.println("<td>"+resultado.getInt(1)+"</td> <td>"+"<td>"+resultado.getString(2)+"</td> <td>"+
                                            "<td>"+resultado.getString(3)+"</td> <td>"+"<td>"+resultado.getString(4)+"</td> <td>"+
                                            "<td>"+resultado.getString(5)+"</td> <td>"+"<td>"+resultado.getInt(6)+"</td> <td>"+
                                            "<td>"+resultado.getInt(7)+"</td> <td>"+"<td>"+resultado.getDouble(8)+"</td> <td>"+
                                            resultado.getDouble(9)+"</td> <td>"+resultado.getDate(10)+"</td> </tr>");
                        }
                        conexion.cerrar();
